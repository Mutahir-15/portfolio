...
**Decision**: I will use `rounded-lg` and create/use a shadow that matches the "terminal green" glow (e.g., `shadow-glow`). If explicit aliases are required, I will add them to `tailwind.config.ts` in Phase 0.
